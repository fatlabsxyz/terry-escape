...
function publicKeySample(id: number) {
  let pk = [ pk_00, pk_01, pk_02, pk_03, pk_04, pk_05, pk_06, pk_07, pk_08, pk_09, pk_10, pk_11 ][id];
  let ps = [ ps_00, ps_01, ps_02, ps_03, ps_04, ps_05, ps_06, ps_07, ps_08, ps_09, ps_10, ps_11 ][id];
  return { key_set: pk, params: ps }
}

function secretKeySample(id: number) {
  let dk = [ dk_00, dk_01, dk_02, dk_03, dk_04, dk_05, dk_06, dk_07, dk_08, dk_09, dk_10, dk_11 ][id];
  dk?.push("0");
  return dk;
}

export { publicKeySample, secretKeySample }
